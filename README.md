...
For a detailed analysis of the system architecture, including UML sequence diagrams (main game loop, chat synchronization, and leaderboard updates), structural blueprints, and testing methodologies, please refer to the explanatory note (in Russian): `Rogoz_Engineering_Notes_RU.pdf`
